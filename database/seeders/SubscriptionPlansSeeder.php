    ...
    public function run(): void
    {
        ...
        $plans = [
            ...
            [
                'key' => 'basic_annual',
                'name' => 'Básico Anual',
                'description' => 'Plan Básico con pago anual. Ahorra 15% comparado con el pago mensual.',
                'price' => 295.80, // $29 * 12 * 0.85 = $295.80
                'currency' => 'USD',
                ...
                'is_custom' => false,
                'show_on_landing' => true,
                'button_text' => 'Contratar Anual',
                'popular_badge' => 'AHORRA 15%',
                'sort_order' => 25,
                'max_users' => 5,
                'max_lots_per_month' => 500,
                'max_storage_gb' => 2,
                ...
                'color' => '#3B82F6',
                'icon' => 'fas fa-seedling',
                'paypal_plan_id' => env('PAYPAL_BASIC_ANNUAL_PLAN_ID'),
                'metadata' => [
                    'discount_percentage' => 15,
                    'monthly_equivalent' => 24.65,
                    'total_savings' => 52.20
                ]
            ],
            [
                'key' => 'premium_annual',
                'name' => 'Premium Anual',
                'description' => 'Plan Premium con pago anual. Ahorra 15% comparado con el pago mensual.',
                'price' => 806.40, // $79 * 12 * 0.85 = $806.40
                'currency' => 'USD',
                'billing_cycle' => 'yearly',
                'trial_days' => 14,
                'is_active' => true,
                ...
                'is_custom' => false,
                'show_on_landing' => true,
                'button_text' => 'Más Popular Anual',
                'popular_badge' => 'MÁS POPULAR + 15% DESCUENTO',
                'sort_order' => 35,
                'max_users' => 25,
                'max_lots_per_month' => 2000,
                'max_storage_gb' => 10,
                ...
                'color' => '#8B5CF6',
                'icon' => 'fas fa-star',
                'paypal_plan_id' => env('PAYPAL_PREMIUM_ANNUAL_PLAN_ID'),
                'metadata' => [
                    'discount_percentage' => 15,
                    'monthly_equivalent' => 67.20,
                    'total_savings' => 141.60
                ]
            ],
            [
                'key' => 'enterprise_annual',
                'name' => 'Enterprise Anual',
                'description' => 'Plan Enterprise con pago anual. Ahorra 15% comparado con el pago mensual.',
                'price' => 2029.80, // $199 * 12 * 0.85 = $2029.80
                'currency' => 'USD',
                'billing_cycle' => 'yearly',
                'trial_days' => 30,
                'is_active' => true,
                ...
                'color' => '#F59E0B',
                'icon' => 'fas fa-crown',
                'paypal_plan_id' => env('PAYPAL_ENTERPRISE_ANNUAL_PLAN_ID'),
                'metadata' => [
                    'discount_percentage' => 15,
                    'monthly_equivalent' => 169.15,
                    'total_savings' => 358.20
                ]
            ],
            [
                'key' => 'corporate_annual',
                'name' => 'Corporativo Anual',
                'description' => 'Plan Corporativo con pago anual. Ahorra 15% comparado con el pago mensual.',
                'price' => 5089.80, // $499 * 12 * 0.85 = $5089.80
                'currency' => 'USD',
                'billing_cycle' => 'yearly',
                'trial_days' => 30,
                'is_active' => true,
                ...
                'color' => '#DC2626',
                'icon' => 'fas fa-building',
                'paypal_plan_id' => env('PAYPAL_CORPORATE_ANNUAL_PLAN_ID'),
                'metadata' => [
                    'discount_percentage' => 15,
                    'monthly_equivalent' => 424.15,
                    'total_savings' => 898.20
                ]
            ]
        ];
        ...
        $this->command->info('Monthly plans: 5');
        $this->command->info('Annual plans: 4 (with 15% discount)');
    }
}