    ...
    private function createSuppliers()
    {
        $suppliers = [
            [
                ...
                'address' => 'Carretera Uruapan-Peribán Km 8, Michoacán',
            ...
            [
                ...
                'address' => 'Av. Revolución 245, Tancítaro, Michoacán',
            ...
            [
                ...
                'address' => 'Calle Juárez 123, Peribán, Michoacán',
            ...
            [
                ...
                'address' => 'Km 15 Carretera a Los Reyes, Michoacán',
                'payment_terms' => 'NET_30',
                'tax_id' => 'RSM920805ST8',
            ...
            [
                ...
                'address' => 'Ejido El Aguacate, Salvador Escalante, Michoacán',
                'payment_terms' => 'IMMEDIATE',
                'tax_id' => 'FTI850923UV1',
    ...
    private function createCustomers()
    {
        $customers = [
            [
                ...
                'address' => 'Blvd. Manuel Ávila Camacho 647, México DF',
            ...
            [
                ...
                'address' => 'Av. Ricardo Margáin 444, Monterrey, NL',
            ...
            [
                ...
                'address' => 'Calle Ernesto Pugibet 21, México DF',
            ...
            [
                ...
                'contact_name' => 'Fernando Ruiz',
                'phone' => '+52 55 4567 8901',
                'email' => 'compras@alsea.com.mx',
                'address' => 'Santa Fe 505, México DF',
            ...
            [
                ...
                'address' => 'Av. Dr. Río de la Loza 195, México DF',
        ...
        foreach ($soldLots as $lot) {
            ...
            for ($i = 0; $i < $numSales && $remainingWeight > 0; $i++) {
                ...
                $sale = Sale::create([
                    ...
                    'discount_amount' => round($totalSaleAmount * ($customer->discount_rate / 100), 2),
                    'final_amount' => round($totalSaleAmount * (1 - $customer->discount_rate / 100), 2),
