            ...
            <div class="px-4 sm:px-6 py-4 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center">
                    <div class="mb-4 sm:mb-0">
                        <h1 class="text-xl sm:text-2xl font-bold text-gray-900 mb-1">System Logs</h1>
                        <p class="text-xs sm:text-sm text-gray-600">View and monitor system logs</p>
                    </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-3 sm:space-y-0">
                    <h3 class="text-base sm:text-lg font-semibold text-gray-900">Log File: {{ $logFile }}</h3>
                    <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2">
                        <select onchange="changeLogFile(this.value)" class="rounded-md border-gray-300 text-xs sm:text-sm">
                        ...
                        <button onclick="refreshLogs()" class="px-3 py-1 bg-blue-600 text-white rounded text-xs sm:text-sm hover:bg-blue-700">
            ...
            <div class="p-4 sm:p-6">
                @if(empty($logs))
                    <div class="text-center py-6 sm:py-8">
                        <i class="fas fa-file-alt text-3xl sm:text-4xl text-gray-400 mb-3 sm:mb-4"></i>
                        <h3 class="text-base sm:text-lg font-medium text-gray-900 mb-2">No logs found</h3>
                        <p class="text-sm text-gray-500">The log file is empty or doesn't exist yet.</p>
                    </div>
                @else
                    <div class="bg-gray-900 rounded-lg p-3 sm:p-4 max-h-80 sm:max-h-96 overflow-y-auto">
                        <code class="text-green-400 text-xs sm:text-sm">
