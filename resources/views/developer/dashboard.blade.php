    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                <a href="{{ route('developer.users.index') }}" class="group bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md hover:border-blue-300 transition-all duration-200">
                    <div class="flex items-start">
                        ...
                        <div class="ml-4 flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 group-hover:text-blue-700 transition-colors">Gestión de Usuarios</h3>
                            <p class="text-sm text-gray-600 mt-1">Administrar usuarios, roles y permisos del sistema</p>
                ...
                <a href="{{ route('developer.config.index') }}" class="group bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md hover:border-green-300 transition-all duration-200">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                        ...
                        <div class="ml-4 flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 group-hover:text-green-700 transition-colors">Configuración del Sistema</h3>
                            <p class="text-sm text-gray-600 mt-1">SMTP, notificaciones push y configuraciones globales</p>
                ...
                <a href="{{ route('developer.backups.index') }}" class="group bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md hover:border-indigo-300 transition-all duration-200">
                    <div class="flex items-start">
                        <div class="flex-shrink-0">
                            <div class="p-3 rounded-lg bg-indigo-100 text-indigo-600 group-hover:bg-indigo-200 transition-colors">
                                <svg class="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="ml-4 flex-1">
                            <h3 class="text-lg font-semibold text-gray-900 group-hover:text-indigo-700 transition-colors">Gestión de Respaldos</h3>
                            <p class="text-sm text-gray-600 mt-1">Crear, descargar y restaurar respaldos del sistema</p>
            ...
            <div class="bg-gray-50 rounded-xl p-6">
                <h3 class="text-lg font-semibold text-gray-900 mb-4">Acciones del Sistema</h3>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <button onclick="clearCache()" class="group bg-white rounded-lg border border-gray-200 p-4 hover:border-yellow-300 hover:shadow-sm transition-all duration-200 text-left">
                        <div class="flex items-center">
                            ...
                            <div class="ml-3 flex-1">
                                <h4 class="text-sm font-semibold text-gray-900 group-hover:text-yellow-700 transition-colors">Limpiar Caché</h4>
                    ...
                    <button onclick="toggleMaintenance()" class="group bg-white rounded-lg border border-gray-200 p-4 hover:border-red-300 hover:shadow-sm transition-all duration-200 text-left">
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                            ...
                            <div class="ml-3 flex-1">
                                <h4 class="text-sm font-semibold text-gray-900 group-hover:text-red-700 transition-colors">Modo Mantenimiento</h4>
